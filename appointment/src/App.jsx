...
function PatientForm() {
  ...
  const handleChang = (e) => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      [name]: value, // Use name instead of id for radio buttons
    }));
  };
  ...
  const handleMedicalHistoryChange = (e) => {
    ...
    setFormData((prevData) => ({
      ...
      medicalHistory: '', // Reset medical history fields when the choice changes
      medicalHistoryFile: null,
    }));
  };
...
<div className="mb-3">
  ...
  <div className="d-flex">
    ...
    />
      ...
      {/* Conditionally render medical history fields if "Yes" is selected */}
